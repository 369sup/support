...
Delivers `/{owner}/{repository}` through `requireCurrentSession`, `getPersonalAccountByUsername`, `getOrganizationByLogin`, `getRepositoryByOwnerAndName`, `resolveEffectiveRepositoryPermission`.
