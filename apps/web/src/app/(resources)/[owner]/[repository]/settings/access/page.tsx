...
export default async function RepositoryAccessSettingsPage({
  params,
}: Readonly<{
  ...
  const organization = await getOrganizationByLogin(routeParams.owner);
        ...
        <div className="mt-3 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-4 max-w-3xl leading-7 text-slate-400">
              Grant, change, or revoke direct team access.
            </p>
          </div>
        </div>
