...
const visibilityClassName =
  "rounded-full border border-slate-600 px-2 py-0.5 text-xs text-slate-400 capitalize";
        ...
        <div className="mt-3 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-4 max-w-3xl leading-7 text-slate-400">
              Browse teams visible to the actor and inspect members, visibility,
              and hierarchy links.
            </p>
          </div>
        </div>
        ...
        <div className="mt-9 grid gap-4">
          {teams.length === 0 ? (
            <p
              ...
              role="status"
            >
              No teams are visible in this context.
            </p>
          ) : (
            teams.map((team) => (
              <section
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-slate-500">
                        @{organization.organization.login}/{team.slug}
                      </p>
                    </div>
                    ...
                    {team.parentTeamId === null ? (
                      ...
                      <span className="inline-flex items-center gap-1.5">
                        <Link2
                          ...
                          className="size-3.5"
                        />
                        Parent team ID {team.parentTeamId}
                      </span>
                    )}
                    ...
                    {team.members.length === 0 ? (
                      ...
                      team.members.map((member) => (
                        ...
                        >
                          ...
                          <span className="rounded-full bg-[#161b22] px-2 py-1 text-xs text-slate-400">
                            {member.isMaintainer
                              ? "Maintainer"
                              : "Member"}
                          </span>
