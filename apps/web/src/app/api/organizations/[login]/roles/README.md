...
Handles GET requests for `/api/organizations/{login}/roles` through `getOptionalCurrentSession`, `isInMemoryRuntimeEnabled`, `listPredefinedOrganizationRoles`, `getOrganizationByLogin`.
