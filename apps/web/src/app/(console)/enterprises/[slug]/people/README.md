...
# Enterprise People Page

## URL contract

- **Route ID:** `page-enterprises-slug-people`
- **Support path:** `/enterprises/{slug}/people`
...
Delivers `/enterprises/{slug}/people` through `requireCurrentSession`, `authorizeEnterpriseAdministration`, `getEnterpriseBySlug`.

The filesystem route is active. Its business behavior remains owned by the referenced module contracts.

## Delivery functions

- Page function: `EnterprisePeoplePage`
