...
# Enterprise Settings Apps Page

## URL contract

- **Route ID:** `page-enterprises-slug-settings-apps`
- **Support path:** `/enterprises/{slug}/settings/apps`
...
Delivers `/enterprises/{slug}/settings/apps` through `requireCurrentSession`, `authorizeEnterpriseAdministration`, `getEnterpriseBySlug`.

The filesystem route is active. Its business behavior remains owned by the referenced module contracts.

## Delivery functions

- Page function: `EnterpriseSettingsAppsPage`
