...
- **Route ID:** `page-enterprises-slug-settings`
- **Support path:** `/enterprises/{slug}/settings`
...
Delivers `/enterprises/{slug}/settings` through `requireCurrentSession`, `authorizeEnterpriseAdministration`, `getEnterpriseBySlug`.

The filesystem route is active. Its business behavior remains owned by the referenced module contracts.

## Delivery functions

- Page function: `EnterpriseSettingsPage`
