...
export default async function EnterpriseSettingsBillingPage({
  params,
    ...
    <main className="flex flex-1 px-4 py-10 sm:px-8 lg:px-10">
      <section className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-3 flex items-start gap-4">
          ...
          <div>
            <h1 className="text-4xl font-semibold tracking-[-0.04em] text-white">Enterprise billing</h1>
            <p className="mt-4 max-w-3xl leading-7 text-slate-400">
              Billing detail pages are intentionally limited while enterprise
              billing orchestration is out of scope. Use this screen as a policy
              placeholder.
            </p>
          </div>
        </div>
        ...
        <div className="mt-9 rounded-xl border border-white/15 bg-[#0a1624] p-6 text-sm leading-7 text-slate-400">
          <p>No invoice, payment, or seat allocation actions are exposed yet.</p>
          <Link
