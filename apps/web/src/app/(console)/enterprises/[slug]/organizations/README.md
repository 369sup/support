...
# Enterprise Organizations Page

## URL contract

- **Route ID:** `page-enterprises-slug-organizations`
- **Support path:** `/enterprises/{slug}/organizations`
...
Delivers `/enterprises/{slug}/organizations` through `requireCurrentSession`, `authorizeEnterpriseAdministration`, `getEnterpriseBySlug`, `listEnterpriseOrganizations`.

The filesystem route is active. Its business behavior remains owned by the referenced module contracts.

## Delivery functions

- Page function: `EnterpriseOrganizationsPage`
