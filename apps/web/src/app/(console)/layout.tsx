...
import { MockAuthBoundary } from "@/app/mock-auth-boundary";
import { MockSignOutButton } from "@/app/mock-sign-out-button";
    ...
    <MockAuthBoundary>
      <div className="flex min-h-dvh flex-col bg-background text-foreground">
        <header className="flex min-h-18 items-center gap-8 border-b px-5 sm:px-8">
          ...
          <nav aria-label="Console" className="flex min-w-0 flex-1 gap-5 overflow-x-auto text-sm text-muted-foreground">
