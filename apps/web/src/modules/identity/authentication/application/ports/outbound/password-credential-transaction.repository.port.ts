export type PasswordCredentialTransactionCommand =
  | Readonly<{
...
export type PasswordCredentialTransactionResult =
  | Readonly<{
...
export interface PasswordCredentialTransactionRepositoryPort {
  apply(
