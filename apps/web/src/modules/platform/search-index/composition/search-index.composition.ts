...
import { PostgresSearchIndexAdapter } from "../adapters/outbound/persistence/postgres-search-index.adapter";
...
const repository = new PostgresSearchIndexAdapter(getProductionDatabase());
