...
const enforcementPaths = [
  "scripts/architecture-checker.mjs",
  "scripts/architecture/exceptions.mjs",
  "scripts/architecture/generated-guidance.mjs",
  "scripts/architecture/source-graph.mjs",
  "scripts/architecture/workspace-packages.mjs",
