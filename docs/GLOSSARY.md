...
Product-semantic evidence terms and concepts are defined by the
[`github-non-code`](github-non-code/README.md) atlas. They are not general
documentation lifecycle or module implementation values.
