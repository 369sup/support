...
- **Activation scope:** accept-organization-invitation, cancel-organization-invitation, change-organization-member-role, check-organization-context-eligibility, decline-organization-invitation, invite-organization-member, list-active-organization-memberships-for-account, list-active-organization-memberships-for-organization, list-organization-invitations-for-organization, list-pending-organization-invitations-for-account, remove-organization-member, update-organization-invitation
...
- **Activation scope:** resolve-app-access-decision
- **Runtime dependencies:** None.
