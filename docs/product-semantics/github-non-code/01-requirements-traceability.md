...
requirementDiagram
    ...
    element AccountProfile {
        ...
        docref: docs/product-semantics/github-non-code/source-register.md
    }
...
| --- | --- | --- | --- |
| Repository dashboard, search, filters, sorting, and creation entrypoint | Confirmed | Active | GH-REPO-009, GH-REPO-010; return only repositories visible to the authenticated actor and distinguish an empty owner from a no-match filter result. |
| Personal or organization ownership, visibility, effective roles, and access sources | Confirmed | Active | GH-REPO-001 through GH-REPO-004; private/internal discovery is permission-filtered and denied lookup is indistinguishable from absence. |
