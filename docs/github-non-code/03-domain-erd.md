# Conceptual Domain ERD

This is a conceptual product model, not a physical database schema. IDs,
principal references, polymorphic owners, and the generic metadata/value fields
