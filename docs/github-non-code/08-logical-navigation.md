...
GH-REPO-003, GH-ISSUE-001, GH-ISSUE-004, GH-DISCUSSION-001,
GH-PROJECT-001, GH-PROJECT-002, GH-PROJECT-005, GH-NOTIFICATION-002,
GH-SEARCH-001, and GH-MODERATION-003 through GH-MODERATION-005.
...
flowchart LR
    ...
    Dashboard --> IssueDashboard["Cross-repository issues and saved views"]
    ...
    Settings --> PersonalModeration["Blocked users and personal interaction limits"]
    ...
    OrgOverview --> OrgSettings["Policies and audit"]
    OrgOverview --> OrgModeration["Blocked users and organization interaction limits"]
    ...
    RepoOverview --> IssuesList["Repository issues list and filters"]
    ...
    RepoSettings --> RepoModeration["Repository interaction limits"]

    Projects --> ProjectView["Table, board or roadmap view"]
    OrgProjects --> ProjectView
    RepoProjects --> ProjectView
    ProjectView --> ProjectSettings["Fields, views, workflows, visibility, close and delete"]
    ProjectSettings --> ProjectAccess["Base, team and individual project access"]
...
- Search results and notification deep links re-evaluate current visibility and
  state.
- Profile, organization, repository, discussion, and project interactions also
  evaluate current block and interaction-limit guards; hiding a menu is not the
