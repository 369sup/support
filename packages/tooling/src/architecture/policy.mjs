...
const ruleEntries = [
  ...
  rule("ARCH-GUIDE-003", "guidance", "required", "checker", "Guidance omits repeated model-version startup boilerplate."),
  rule("ARCH-GUIDE-004", "guidance", "knowledge", "checker", "Nested guidance avoids exact inherited paragraph duplication."),
  rule("ARCH-GUIDE-005", "guidance", "knowledge", "checker", "Guidance stays within repository context budgets."),
  ...
  rule("ARCH-PKG-011", "workspace", "required", "checker", "Supabase SDK dependencies and imports are isolated behind the Supabase package."),
  rule("ARCH-PKG-012", "workspace", "required", "checker", "Package-owned configuration and assets do not select application paths."),
  ...
  rule("ARCH-ROUTE-004", "route", "required", "checker", "Delivery functions and documented-only materialization match the route catalog."),
  rule("ARCH-ROUTE-005", "route", "required", "checker", "Route module ownership and public-entrypoint imports agree."),
  rule("ARCH-ROUTE-006", "route", "required", "checker", "Route use-case references exist in module contracts."),
  rule("ARCH-ROUTE-007", "route", "required", "checker", "Route sources are official GitHub Docs or explicit repository evidence."),
